...
"\n"
"            if(hypot(particlesInput[i].position.x - particlesInput[indexB].position.x, particlesInput[i].position.y - particlesInput[indexB].position.y) <= 2*radius) {\n"
"                particlesOutput[i].position = particlesInput[i].position;\n"
"                particlesOutput[indexB].position = particlesInput[indexB].position;\n"
"                particlesOutput[i].velocity = particlesInput[i].velocity;\n"
"                particlesOutput[indexB].velocity = particlesInput[indexB].velocity;\n"
"\n"
"                return;\n"
"            }\n"
"\n"
